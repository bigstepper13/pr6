...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        main_activity_button = (Button) findViewById(R.id.button);
        main_activity_edit_text = (EditText) findViewById(R.id.edit_text);
        ...
        main_activity_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                main_activity_edit_text.setHint(getResources().getString(R.string.name_2));
                main_activity_edit_text.setHintTextColor(Color.GREEN);
            }
        });
